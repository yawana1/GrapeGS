...
def main(argv=None):
    ...
    try:
        ...
        parser.add_option("-s", "--in", dest="segfile", help="set input path [default: %default]", metavar="FILE")
...
#             print("outfile = %s" % opts.outfile)
        ...
        try:
            callset = allel.read_vcf(opts.infile)
...
#         sys.argv.append("-h")
    ...
    if PROFILE:
        import cProfile
        import pstats
        profile_filename = 'IBDcoef_profile.txt'
